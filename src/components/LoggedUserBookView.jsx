...
const LoggedUserBookView = ({ currentPage, currentProducts, handleNextPage, handlePrevPage, decodedToken, totalPages }) => {
    return (
        <>
            <Box sx={{ m: { xs: '18px auto', md: '50px auto' }, width: { xs: '90%', md: '80%' }, display: 'flex', alignItems: 'center', justifyContent: 'center', pb: '50px' }}>
            ...
            {currentProducts.length === 0 && <Box display='flex' justifyContent='center' height='100vh' mt={8}><Typography variant='h4' color='white' fontWeight='bold'>No Records</Typography></Box>}
        </>
    )
}
